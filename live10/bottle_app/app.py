...
@get('/')
@jinja2_view('/home/blackrose/Documents/EstudosPython/aulas/livesPython/live10/bottle_app/main.html')
def index():
...
@get('/cadastro')
@jinja2_view('/home/blackrose/Documents/EstudosPython/aulas/livesPython/live10/bottle_app/cadastro.html')
def cadastro():
...
@post('/cadastro')
@jinja2_view('/home/blackrose/Documents/EstudosPython/aulas/livesPython/live10/bottle_app/generic.html')
def castro_post():
...
@get('/login')
@jinja2_view('/home/blackrose/Documents/EstudosPython/aulas/livesPython/live10/bottle_app/login.html')
def login():
